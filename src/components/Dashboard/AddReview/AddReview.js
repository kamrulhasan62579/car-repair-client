...
export default function AddReview() {
  ...
  const onSubmit = data => {
    console.log(data)
    fetch("http://localhost:3011/addReview", {
      method: 'POST',
   ...
   <div className="d-flex justify-content-center">
     <div className="col-xxl-7 col-lg-10 col-xl-7">
      <form onSubmit={handleSubmit(onSubmit)}>
           <h5 className="text-center">You can add your comment here, that shows in home page </h5>
      ...
      <textarea className="form-control" name="description" id="" cols="100%" rows="10" placeholder="Describing your comment about our service..." {...register("description", { required: true })} ></textarea>
